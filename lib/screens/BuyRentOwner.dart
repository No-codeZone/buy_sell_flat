...
import 'package:buy_sell/screens/sub_screens/BuyRentGalleryNew.dart';
...
class BuyRentOwner extends StatefulWidget {
  const BuyRentOwner({super.key});

  @override
  State<BuyRentOwner> createState() => _BuyRentOwnerState();
}

class _BuyRentOwnerState extends State<BuyRentOwner> {
