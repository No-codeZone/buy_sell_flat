...
class BuyRentGalleryNew extends StatefulWidget {
  const BuyRentGalleryNew({super.key});

  @override
  State<BuyRentGalleryNew> createState() => _BuyRentGalleryNewState();
}

class _BuyRentGalleryNewState extends State<BuyRentGalleryNew> {
  @override
