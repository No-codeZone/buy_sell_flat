...
import 'RequestContact.dart';

class BuyRentFlatProfile extends StatefulWidget {
  const BuyRentFlatProfile({super.key});

  @override
  State<BuyRentFlatProfile> createState() => _BuyRentFlatProfileState();
}

class _BuyRentFlatProfileState extends State<BuyRentFlatProfile> {
  int currentTab = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      ///Animated bottom navigation bar is here !
    );
  }
}
